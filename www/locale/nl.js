{
   "messages" : {
      ...
      "Weather algorithm uses Weather Underground data in conjunction with the selected algorithm to adjust the watering level" : "Het weer algoritme gebruikt Weather Undergroud data in combinatie met  het geselecteerde algoritme om het sproei percentage aan te passen",
      "Reset" : "Herstarten",
      "Options" : "Opties",
      "Norwegian" : "Noors",
      ...
      "Use Weather Control" : "Gebruik Weer Controle",
      "Stations" : "Stations",
      "m" : "m",
      ...
      "The watering level modifies station run times by the set percentage. When a weather algorithm is used the watering level is automatically adjusted." : "Het sproei percentage wijzigt de looptijd van het station met het opgegeven percentage. Wanneer een weer algoritme is toegepast wordt het sproei percentage automatisch aangepast.",
      "Dutch" : "Nederlands",
