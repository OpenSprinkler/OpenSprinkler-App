{"messages":
{
   ...
   "Using manual watering": "Полив вручную",
   "Unrecognised weather provider": "Неизвестный источник погоды",
   "Forecast": "Прогноз",
   "Refresh": "Обновить",
   "Now": "Сейчас",
   "Sunrise": "Рассвет",
   ...
   "Last Request": "",
   "Last Response": "",
   "Change Rain Delay": "Дождевая Задержка",
   ...
   "Show Disabled": "",
   "(Changes Auto-Saved)": "(Настройка автоматически сохранена)",
