...
function showOptions( expandItem ) {
	...
	list += "<div class='ui-field-contain'>"+
	    "<label for='displayOption'>"+_( "Mainpage display" )+"</label>" +
		"<select name='displayOption' id='displayOption' data-mini='true'>"+
		"<option value='0'"+sel[0]+">"+_( "Hide all")+"</option>"+
		"<option value='1'"+sel[1]+">"+_( "Show Zones")+"</option>"+
		"<option value='2'"+sel[2]+">"+_( "Show Programs")+"</option>"+
		"<option value='3'"+sel[3]+">"+_( "Show all")+"</option>"+
		"</select></div>";
	...
	var page = $( "<div data-role='page' id='logs'>" +
		...
		prepTable = function() {
			...
			logsList.find( ".delete-day" ).on( "click", function() {
				...
				areYouSure( _( "Are you sure you want to delete" ) + " " + date + "?", "", function() {
					$.mobile.loading( "show" );
...
var showAbout = ( function() {
	...
	var page = $( "<div data-role='page' id='about'>" +
			"<div class='ui-content' role='main'>" +
				...
				"</ul>" +
				"<p class='smaller'>" +
					_( "App Version" ) + ": "+document.documentElement.getAttribute("data-appversion")+" ASB" +
...
function stopAllStations( callback ) {
