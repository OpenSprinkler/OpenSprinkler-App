...
// Helpers
var helpers       = require('./blanket_support/mocha-helpers');
...
module.exports = function(grunt) {
    ...
    var phantomjsEventManager = (function() {
        ...
        phantomjs.on('blanket:fileDone', function(thisTotal, filename, lcov) {
    ...
    grunt.registerMultiTask('blanket_mocha', 'Run Mocha unit tests in a headless PhantomJS instance.', function() {
        ...
        var options = this.options({
            ...
            inject: asset('tasks/blanket_support/bridge.js'),
            // Main PhantomJS script file
            phantomScript: asset('tasks/blanket_support/main.js'),
